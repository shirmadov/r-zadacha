...
@section('content')
    <section class="news__read__section">
        <div class="container">

            <div style="display: flex;margin-bottom:20px">
                <div class="news_section">
                    <div class="news__read__main">
                        <div>
                            <h1 class="news__read__title">{{$new->title}}</h1>
                            <img class="news__read__img" src="{{asset('img/first.png')}}" alt="">
                            <p class="news__read__text">
                                {{$new->text}}
                            </p>
                        </div>
...
{{--                            <span class="blogs__number__likes">37,701</span>--}}
                            ...
                            <div style="width: 50%;display: inline-block;cursor:pointer;">
                                             <span class="news__comment__icon" style="display: inline-block">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="30" viewBox="0 0 24 24" fill="none">
                            ...
                            <path d="M8.5 12.5L13.5 12.5" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <span class="news__number__comments">201</span>
                                <span class="news__comments">Комментарии</span>
                            </div>

                            <div style="float: right">
                                <span class="news__read__publish__date">Jan 25, 2022</span>
                            </div>
                        </div>

                        <hr style="width: 100%; border:0.5px solid #000000 ">
